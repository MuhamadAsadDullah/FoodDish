<x-app-layout>
    ...
    <div class="container bg-white" style="min-height: 80vh">
      <div class="row">
        <div class="col-lg-9 col-sm-6 mb-xl-0 pt-3">
              ...
              <div class="search">
                <form action="" class="d-flex">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control px-2" name="search" value="{{ request()->search }}" placeholder="Cari ...">
              ...
              <div class="filter mx-4">
                <form action="" method="GET" id="formSort">
                  ...
                  <select class="form-select pe-5" aria-label="Default select example" name="sort" onchange="document.getElementById('formSort').submit()">
                    <option {{ request()->sort == 1 ? 'selected' : '' }} value="1">Urut</option>
                    <option {{ request()->sort == 2 ? 'selected' : '' }} value="2">A-Z</option>
                    <option {{ request()->sort == 3 ? 'selected' : '' }} value="3">Z-A</option>
                    <option {{ request()->sort == 4 ? 'selected' : '' }} value="4">Termurah</option>
                    <option {{ request()->sort == 5 ? 'selected' : '' }} value="5">Termahal</option>
                  </select>
                </form>
              </div>
            </div>
                          ...
                          <div class="carousel-inner">
                            ...
                            @empty
                              <div class="carousel-item active">
                                <img src="{{ asset('img/product/noimage.png') }}" class="d-block w-100" alt="Gambar">
                              </div>
                            @endforelse
                          </div>
                      ...
                      @if (Auth::user()->role === 1)
                        <div class="card-footer py-0 my-0 d-flex" >
                          <form action="/product/{{ $product->id }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn w-100"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="12"     fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
        ...
        <div class="col border-start bg-white" id="cartSection" style="min-height: 80vh;">
          ...
          <div>
            ...
            <p>* pajak tidak termasuk</p>
            <div class="d-flex w-100">
              <button class="btn w-100 mx-2" onclick="removeCart()">Hapus</button>
              <button class="btn btn-warning w-100 mx-2" onclick="checkOut()">Beli</button>
            </div>
          </div>
        </div>
      </div>
          ...
          child.innerHTML = `
            <div class="card mb-2" style="max-width: 540px;">
              <div class="row g-0 align-items-center">
                <div class="col-md-3">
                  ${productData && productData.images.length > 0 ?  '<img src="" class="d-block w-100" alt="">' : '<img src="{{ asset("img/product/noimage.png") }}" class="d-block w-100" alt="">'}
                </div>
                <div class="col-md-9">
                  <div class="card-body">
